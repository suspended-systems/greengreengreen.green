	...
	return (
		<DayPicker
			...
			classNames={{
				...
				head_row: "flex py-4",
				head_cell: `text-muted-foreground rounded-md w-14 md:w-24 font-normal text-[0.8rem]`,
				row: "flex w-full",
				cell: cn(
				...
				day: cn(buttonVariants({ variant: "ghost" }), `size-14 md:size-24 p-0 font-normal aria-selected:opacity-100`),
